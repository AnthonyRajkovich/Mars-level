...
def player_animation():
    global walkcount, player_x, i, font, text_launcher, walking, part4, j, MarsIntroText, MarsIntroText1
    screen.blit(background, (0,0))
    screen.blit(launcher, (screen_width / 120 * 27 - int(launcher.get_width() / 4), screen_height / 120 * 95 - int(launcher.get_height() /2)))
    screen.blit(target, (screen_width * i/48, screen_height * 36/40))
    screen.blit(text_launcher, (screen_width *2 / 6, screen_height/8))
    ...
    if player_x > screen_width / 100 * 41:
        ...
        if j == 1: 
           screen.blit(MarsIntroText, (screen_width * 3/8, screen_height * 3/8))
           pygame.display.flip()
           Part4.play()
           pygame.time.delay(15000)
           fill()
           screen.blit(MarsIntroText1, (screen_width * 3/8, screen_height * 3/8))
           pygame.display.flip()
...
MarsIntroText = pygame.image.load("MarsIntroText(13).png")
MarsIntroText1 = pygame.image.load("MarsIntroText(14).png")

Part4 = pygame.mixer.Sound('Part4.wav')
